...
;*******************************************************************************
;no es lo mismo escribir 1234 en memoria que en los registros
...
; DEFINICION DEL SEGMENTO DE CODIGO se insertan porque las variables no se ejecutan
...
START PROC 
    ;INICIALIZA LOS REGISTROS DE SEGMENTO CON SUS VALORES -- fundamental para relacionar los reg del seg con reg conocidosd para nosotros
    MOV AX, DATOS 
    MOV DS, AX 
