...
FILA1 DB 0,0,0,0 ;; Primera fila de la matriz
FILA2 DB 0,0,0,0 ;; Segunda fila de la matriz
FILA3 DB 0,0,0,0 ;; Tercera fila de la matriz
FILA4 DB 0,0,0,0 ;; Cuarta fila de la matriz
CONVERSION DB ?
...
PROCESO:
	...
	COMIENZO:;;COMIENZO DEL BUCLE		
		MOV AH, DS:FILA1[DI+1];; COMO ES SOLO 1B COGEMOS LA PARTE ALTA DEL CODIGO
...
DUPLICADOSFILAS PROC 
	MOV SI, 0
	COMIENZOFILAS:
		MOV AH, DS:FILA1[SI+1];; COMO ES SOLO 1B COGEMOS LA PARTE ALTA DEL CODIGO
		CMP AH, 4			  ;; COMPARAMOS SI ES MAYOR QUE 4
		JG ERRF  
		CMP AH, 1			  ;; COMPROBAMOS SI ES MENOR QUE 1
		JL ERRF
		ADD SI, 1
		MOV AL, DS:FILA1[SI+1];;CARGAMOS EL SIGUIENTE NUMERO
		...
		JE ERRF
		ADD SI, 1
		MOV BH, DS:FILA1[SI+1];;CARGAMOS EL SIGUIENTE NUMERO
		...
		JE ERRF
		ADD SI, 1
		MOV BL, DS:FILA1[SI+1];;CARGAMOS EL SIGUIENTE NUMERO
